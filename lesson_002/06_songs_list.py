...
sum = violator_songs_list[3][1] + violator_songs_list[5][1] + violator_songs_list[-1][1]
sum = round(sum, 2)
print("Три песни звучат " + str(sum) + " минут")
...
sum = round(sum, 2)
print("А другие три песни звучат " + str(sum) + " минут")